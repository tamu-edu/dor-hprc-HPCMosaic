const ElementDescriptions = {
    "Node Utilization": "Displays the current and available computing resources across nodes.",
    PyVenvManager: "Manage Python virtual environments directly from the dashboard.",
    "Quota Info": "Shows disk quota usage and limits for users and groups.",
