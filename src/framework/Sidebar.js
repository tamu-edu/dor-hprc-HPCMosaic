...
const Sidebar = () => {
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-gray-800">
      ...
      <div className="bg-gray-50 dark:bg-gray-900 p-4 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-10">
        <div className="flex items-center justify-between mb-4">
          <div className="relative flex-grow mr-4">
            ...
            <input
              ...
              className="block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
              value={searchTerm}
          ...
          <div className="flex items-center space-x-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md">
            <button
              onClick={() => setViewMode("grid")}
              className={`p-2 rounded-l-md ${viewMode === "grid" ? "bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300" : "text-gray-500 dark:text-gray-400"}`}
              title="Grid view"
            >
            ...
            <button
              ...
              className={`p-2 rounded-r-md ${viewMode === "list" ? "bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300" : "text-gray-500 dark:text-gray-400"}`}
              title="List view"
            >
        ...
        <div className="flex flex-wrap items-center gap-2">
          <span className="text-sm font-medium text-gray-600 dark:text-gray-300 mr-1 flex items-center">
        ...
        {filteredList.length === 0 ? (
          ...
          <div className="flex flex-col space-y-4 w-full">
            {filteredList.map((name, id) => {
              const { cardComponent: CardComponent } = CardConfig[name];
              return (
                <div key={id} className="w-full transition-colors hover:bg-blue-50 dark:hover:bg-blue-900/20">
                  <CardComponent />
                </div>
              );
            })}
